...
if [ ! -d "./packer_0.11.0" ]; then
    wget -O ./packer_0.11.0.zip https://releases.hashicorp.com/packer/0.11.0/packer_0.11.0_linux_amd64.zip
    unzip ./packer_0.11.0.zip -d ./packer_0.11.0/
fi
